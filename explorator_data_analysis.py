{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "8a9a00bf-f6f3-4886-a504-2c6115c64ff6",
   "metadata": {},
   "source": [
    "# Exploratory Data Analysis\n",
    " Understanding the datasets to explore how the data is present in the database and if there is a need for creating some aggregated tables that can help with\n",
    "\n",
    "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "64a76a73-2b79-412a-a9f1-f5ffc0340cad",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "37dbe2ce-6cb2-481c-9376-d93062fc6863",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "7b83aa54-697b-4331-ac08-19674cadb9f4",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "b0a002d5-bf83-497a-a82a-0d6868d00b6e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "e8dc9f71-27a2-42df-875e-9ba7bb96308b",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "ddb218f1-af30-4008-8374-f9e5c03360a3",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "0cbd14f7-d2d0-4caa-87e1-41869644adf6",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "d85c99e9-9d30-4180-bb8d-391caf519001",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "607afef0-0104-4f68-8665-5b4928e4a313",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "0d5ceeba-de23-489f-bd4a-17ddef3d39c4",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "ea80a7f0-6c68-461a-ba03-ef096a42d49f",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "59c71ada-add8-4015-ab7d-3f3b3ff3fa9e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "d67515aa-064b-49d1-89c1-8acf383f90d8",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 14,
   "id": "1e0cdfd6-98d7-4757-b12f-4640122d03d2",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 15,
   "id": "6dcc7c77-4cab-42e4-a346-7f91068268d8",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "id": "d2ec98de-3ed7-47c9-a891-a956e687221b",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "markdown",
   "id": "4c33dd74-591d-47d6-b4db-cfcf6a503f28",
   "metadata": {},
   "source": [
    "- The purchases table contains actual purchase data, including the data of purchases, products (brands) purchased by vendors, the amount paid (in dollars), and the quantity purchased.\n",
    "\n",
  ...
  {
   "cell_type": "markdown",
   "id": "4c58ef98-8d48-471b-8d16-30f72ba0df22",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "b41ecf85-cd8b-4e7b-9384-fb8df31bb3a6",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 17,
   "id": "4a1290b0-4b94-461c-88c8-d05352652384",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 18,
   "id": "6d8091cd-07e2-4f61-a315-3458047896ae",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0              2561  EDRINGTON AMERICAS            2166           0.00    750   \n",
       "1              7245  PROXIMO SPIRITS INC.          3065           0.71     50   \n",
       "2              3960  DIAGEO NORTH AMERICA INC      6127           1.47    200   \n",
       "3              3924  HEAVEN HILL DISTILLERIES      9123           0.74     50   \n",
       "4              8004  SAZERAC CO INC                5683           0.39     50   \n",
       "...             ...                          ...    ...            ...    ...   \n",
       "10688          3960  DIAGEO NORTH AMERICA INC      3545          21.89   1750   \n",
       "10689          3960  DIAGEO NORTH AMERICA INC      4261          16.17   1750   \n",
       "10690         17035  PERNOD RICARD USA             8068          18.24   1750   \n",
       "10691          4425        MARTIGNETTI COMPANIES   3405          23.19   1750   \n",
       "10692          1128  BROWN-FORMAN CORP             1233          26.27   1750   \n",
       "\n",
       ...
       "4             0.49                      6                  2.34  \n",
       "...            ...                    ...                   ...  \n",
       "10688        29.99                 138109            3023206.01  \n",
       "10689        22.99                 201682            3261197.94  \n",
       "10690        24.99                 187407            3418303.68  \n",
       "10691        28.99                 164038            3804041.22  \n",
       "10692        36.99                 145080            3811251.60  \n",
       "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 19,
   "id": "5f8809f1-d0c8-494d-961e-9b22f65d0045",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "4             4.99                      2                  2.64  \n",
       "...            ...                    ...                   ...  \n",
       "10687        29.99                 138109            3023206.01  \n",
       "10688        22.99                 201682            3261197.94  \n",
       "10689        24.99                 187407            3418303.68  \n",
       "10690        28.99                 164038            3804041.22  \n",
       "10691        36.99                 145080            3811251.60  \n",
       "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 20,
   "id": "8def4a53-37ee-4cd0-b714-35e41b0826c0",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 21,
   "id": "4023c0a5-d1b0-4005-83f6-dc5c1da465e1",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "       VendorNo  Brand  TotalSalesDollars  TotalSalesPrice  \\\n",
       "0          8004   5287               0.98             0.98   \n",
       "1          9206   2773               0.99             0.99   \n",
       "2          3252   3933               1.98             0.99   \n",
       "3          3924   9123               1.98             0.99   \n",
       "4         10050   3623               1.98             1.98   \n",
       "...         ...    ...                ...              ...   \n",
       "11267      3960   3545         4223107.62        545778.28   \n",
       "11268      3960   4261         4475972.88        420050.01   \n",
       "11269     17035   8068         4538120.60        461140.15   \n",
       "11270      4425   3405         4819073.49        561512.37   \n",
       "11271      1128   1233         5101919.51        672819.31   \n",
       "\n",
       "       TotalSalesQuantity  TotalExciseTax  \n",
       "0                       2            0.10  \n",
       "1                       1            0.05  \n",
       "2                       2            0.10  \n",
       "3                       2            0.10  \n",
       "4                       2            0.10  \n",
       "...                   ...             ...  \n",
       "11267              135838       249587.83  \n",
       "11268              200412       368242.80  \n",
       "11269              187140       343854.07  \n",
       "11270              160247       294438.66  \n",
       "11271              142049       260999.20  \n",
       "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 22,
   "id": "34640120-ea56-4c8b-b136-3bebe6fc2f72",
   "metadata": {},
   "outputs": [],
   "source": [
    "# import time\n",
    ...
    "# Sum(s.SalesPrice)as TotalExciseTax,\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 35,
   "id": "d5c22e17-1867-4fe7-9a4c-3b53b29eebb2",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2                 Absolut 80 Proof          18.24        24.99   1750   \n",
       "3           Capt Morgan Spiced Rum          16.17        22.99   1750   \n",
       "4                  Ketel One Vodka          21.89        29.99   1750   \n",
       "...                            ...            ...          ...    ...   \n",
       "10687  Concannon Glen Ellen Wh Zin           1.32         4.99    750   \n",
       "10688  Dr McGillicuddy's Apple Pie           0.39         0.49     50   \n",
       "10689              Deep Eddy Vodka           0.74         0.99     50   \n",
       "10690  The Club Strawbry Margarita           1.47         1.99    200   \n",
       "10691     Three Olives Grape Vodka           0.71         0.99     50   \n",
       "\n",
  ...
  {
   "cell_type": "markdown",
   "id": "51bc2ade-dbeb-4ca1-bfc3-dc846f546fe0",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 36,
   "id": "a25691c1-4de3-4839-95fb-e57d2cd27c99",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 37,
   "id": "b7cca642-2885-4c4e-bce9-eedb7fe58b55",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 41,
   "id": "042135f7-11a7-4d51-ae81-26cce096c35d",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 43,
   "id": "a99e072a-172a-4b26-853e-09a1158c5bc1",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 45,
   "id": "149ae771-5280-4b5a-8db9-9d6c4154f02e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 46,
   "id": "5aca6b98-2474-4290-99b6-48aea790a26d",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 48,
   "id": "de42aca7-5d4e-48af-9f36-e17bf077981d",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 49,
   "id": "cabba023-d079-43a4-82c3-b35ea0724be1",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 50,
   "id": "92d3a3b1-d018-49a8-8fa3-b78a7e222c5f",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 51,
   "id": "9c389b0d-e6c6-460c-80d3-d9f7551bd7ac",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 52,
   "id": "3a9270b3-833f-4f37-b863-65bc06a11abb",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 53,
   "id": "f10cf4e4-0495-4b6d-91a8-1d829b05044a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 56,
   "id": "9a4199ad-a1c9-476e-9cbd-2c19dd8803d3",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 57,
   "id": "c779a731-4d7d-4eb8-8dcd-7685976167de",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 60,
   "id": "ffb6f84f-4923-4c45-af92-93b21e38dfeb",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 61,
   "id": "eddc2e57-d707-4c92-a445-bbb34e8f33a6",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 62,
   "id": "c904a4ac-8c84-4d3a-aa98-608ca3c444cc",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 67,
   "id": "b95e4299-278e-4069-831d-7ce9f42a9fb4",
   "metadata": {},
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<sqlite3.Cursor at 0x1f668da61c0>"
      ]
     },
     "execution_count": 67,
     "metadata": {},
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 68,
   "id": "ed3e7eee-e906-4573-a216-b2f83a0be6af",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 69,
   "id": "5634f9ca-6023-42f3-ad5f-0400d0771546",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 70,
   "id": "c75c0294-b956-4bcb-90ff-66c0fc8428d6",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "10691              85.14            33.66            4.46     38994.78   \n",
       "\n",
       "       GrossProfit  ProftMargin  ProfitMargin  StockTurnover  \\\n",
       "0       1290667.91    25.297693     25.297693       0.979108   \n",
       "1       1015032.27    21.062810     21.062810       0.976890   \n",
       "2       1119816.92    24.675786     24.675786       0.998575   \n",
       "3       1214774.94    27.139908     27.139908       0.993703   \n",
       "4       1199901.61    28.412764     28.412764       0.983556   \n",
       "...            ...          ...           ...            ...   \n",
       "10687        13.31    83.448276     83.448276       2.500000   \n",
       "10688        63.32    96.436186     96.436186      22.333333   \n",
       "10689         0.50    25.252525     25.252525       1.000000   \n",
       "10690       141.81    98.974037     98.974037      72.000000   \n",
       "10691        84.43    99.166079     99.166079      86.000000   \n",
       "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "c1a58fb1-9160-4f94-b88f-d5956a4b7ad3",
   "metadata": {},
   "outputs": [],
   "source": []
  }
